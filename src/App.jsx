...
const App = () => {
  ...
  // États pour les stats globales animées
  const [globalStats, setGlobalStats] = useState({ scanRate: 0, cpuLoad: 0, latency: 24 });

  // Logs et Alertes
  const [logs, setLogs] = useState([
    { id: Date.now(), text: "Cluster v4.2.0 initialisé.", type: "sys" },
    { id: Date.now() + 1, text: "Authentification API réussie.", type: "sys" }
  ]);
      ...
      if (Math.random() > 0.4) {
        ...
        if (activeBots.length > 0) {
          ...
          const newLog = { 
            ...
            text: `Instance #${randomBot.id.toString().padStart(2, '0')}: Scan complété sur ${Math.random().toString(36).substring(7)}`,
            type: "scan"
          };
        ...
        {activeTab === 'dashboard' && (
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              ...
              <StatCard title="Scans/min" value={isPaused ? 0 : globalStats.scanRate} icon={<Globe className="text-purple-400"/>} sub="Débit cluster" />
              <StatCard title="Latence" value={`${globalStats.latency}ms`} icon={<Zap className="text-yellow-400"/>} sub="Stable" />
              <StatCard title="CPU Load" value={isPaused ? "2.1%" : `${globalStats.cpuLoad}%`} icon={<Server className="text-green-400"/>} sub="Charge système" />
            </div>
                ...
                <div className="bg-[#141822] border border-white/5 rounded-3xl overflow-hidden shadow-2xl">
                  <div className="p-6 border-b border-white/5 bg-white/[0.01] flex justify-between items-center">
                      <h3 className="font-bold flex items-center gap-2 text-sm uppercase tracking-wider text-slate-300">
                          <Eye size={16} className="text-blue-400" /> Détections Critiques
                      </h3>
                    ...
                    <table className="w-full text-left">
                      <thead className="text-[10px] text-slate-500 uppercase tracking-widest bg-white/[0.01]">
                        <tr>
                          ...
                          <th className="px-6 py-4">Détenteur</th>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#141822] border border-white/5 rounded-3xl p-6 relative overflow-hidden">
                   ...
                   <div className="bg-[#2b2d31] rounded-xl p-4 border-l-4 border-blue-500 shadow-xl">
                      ...
                      <div className="text-[10px] font-bold text-blue-300 mb-1">🚨 CRITICAL_OG_FOUND</div>
        ...
        {activeTab === 'heatmap' && (
          <div className="bg-[#141822] border border-white/5 rounded-3xl p-8 min-h-[600px] relative overflow-hidden animate-in zoom-in duration-700 flex flex-col items-center justify-center">
              <div className="absolute top-8 left-8">
                  ...
                  <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.3em]">Détection d'objets de valeur</p>
              </div>
             ...
             <div className="bg-[#141822] border border-white/5 p-8 rounded-3xl space-y-8 shadow-xl">
                <div>
                   <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="font-black text-white uppercase tracking-widest text-sm">Paramètres de Scan</h3>
                   </div>
                   <div className="space-y-6">
                      <SettingInput label="Seuil de détection OG (Billions)" value="1.5" />
                      <SettingInput label="Buffer de détection (ms)" value="250" />
                      <SettingToggle label="Alerte Sonore Haute-Priorité" active={true} />
                      <SettingToggle label="Auto-Rizz Protocol v4" active={false} />
                   </div>
                </div>
                <div className="pt-6 border-t border-white/5">
                   <h3 className="font-black text-slate-500 text-[10px] uppercase tracking-widest mb-6 italic">Fréquence de rafraîchissement</h3>
                   <div className="flex items-center gap-6">
             ...
             <div className="bg-[#141822] border border-white/5 p-8 rounded-3xl flex flex-col justify-between shadow-xl">
                <div>
                   <div className="flex items-center gap-3 mb-6">
                        ...
                        <h3 className="font-black text-white uppercase tracking-widest text-sm">Sécurité & API</h3>
                   </div>
                   <div className="space-y-6">
                      <div className="p-5 bg-white/5 rounded-2xl border border-white/5 group hover:border-blue-500/30 transition-all">
                         ...
                         <div className="flex justify-between items-center bg-black/20 p-3 rounded-lg">
                            <span className="text-xs font-mono text-white tracking-widest">•••• •••• •••• 98XZ</span>
